 ...
 * เอาตัวเลขมาปนกันค่าเฉลี่ยจะหลอกตา
 *
...
/** ปีของกลุ่มอาจารย์ → แท็บเริ่มต้น · รับแค่ 5/6 นอกนั้นเป็น 'รวมปี' (ค่าอื่นไม่มีแท็บรองรับ = เปิดมาเจอหน้าว่าง) */
export function defaultYearView(year: number | undefined): YearView {
