 ...
 *
 * UI อ่าน/เขียนที่นี่ผ่าน repo.ts เท่านั้น · การส่งขึ้นเซิร์ฟเวอร์เป็นหน้าที่ของ middleware
 * ใน cloudSync.ts ซึ่งดักการเขียนทุกครั้ง — ไฟล์นี้จึงไม่รู้จัก Supabase
 */
...
export class ProsthoDB extends Dexie {
  ...
  constructor() {
     ...
     * · ข้อมูลเดิมมีแค่ year 5/6 จึงเดารุ่นย้อนจากปีการศึกษา
