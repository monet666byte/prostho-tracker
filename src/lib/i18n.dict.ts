...
export const DICT: Record<string, string> = {
  ...
  'ไม่พบนักศึกษาที่ค้นหา': 'No matching students',
  'เลือกรุ่น': 'Cohort',
  'ทุกรุ่น': 'All cohorts',
  ...
  'กำลังดึง…': 'Pulling\u2026',
  'ดึงข้อมูลจากชีต': 'Pull from sheet',
  ...
  'งานเหลือ 24 ขั้น × 1.5 = 36 คาบ · มีอยู่ {n} คาบ → เหลือเผื่อ {b} คาบ = เขียว': '24 steps left \u00d7 1.5 = 36 periods \u00b7 {n} available \u2192 {b} periods of slack = green',
  'ตัวอย่าง': 'Example',
  '③ เทียบกับคาบที่เหลือถึงปลายปีการศึกษา — ตอนนี้ ~{n} คาบ (เกิน ~{a} คาบเมื่อไหร่ = ส้ม)': '\u2462 Compare with the periods left until year end \u2014 ~{n} now (over ~{a} turns amber)',
  'งานกินคาบเกินที่มี · หรือยังไม่มีเคสในมือเลย · หรือมาคลินิกแล้ว step ไม่ขยับ 3 คาบติด': 'Work needs more periods than are left \u00b7 or no active case at all \u00b7 or attended 3 periods in a row with no step passed',
  'เหลือเผื่อน้อยแล้ว (ไม่ถึง 30%) — ทันแต่ห้ามสะดุด': 'Little slack left (under 30%) \u2014 doable but nothing can go wrong',
  'ยังเหลือคาบเผื่อสบายๆ (เกิน 30% ของที่มี)': 'Comfortable slack left (over 30% of what they have)',
  'คิดเหมือนงบเวลา: ตอนนี้มีคาบเหลือ ~{n} คาบ · งานที่ต้องทำแปลงเป็นคาบแล้วเทียบว่าเหลือเผื่อเท่าไหร่': 'Think of it as a time budget: ~{n} clinic periods left \u00b7 remaining work is converted into periods, then we look at the slack',
  'เรียงคนที่น่าห่วงไว้บน · กดชื่อเพื่อดูงานรายคน': 'Most at-risk first \u00b7 tap a name to see their cases',
  '⚠️ เลขคาบเป็นค่าประมาณจากสมมติฐาน (คาบ/สัปดาห์ ปรับได้ที่ “ตั้งค่าเกณฑ์”) — ใช้จัดลำดับว่าควรดูใครก่อน ไม่ใช่คำตัดสิน': '\u26a0\ufe0f Period counts are estimates (periods per week is adjustable in Settings) \u2014 use them to prioritise who to check first, not as a verdict',
  '② รวม step ที่เหลือของเคสเหล่านั้น × ~1.5 คาบ/step = คาบที่ต้องใช้': '\u2461 Sum their remaining steps \u00d7 ~1.5 periods per step = periods needed',
  '① นับเฉพาะเคสที่ใกล้จบสุดเท่าที่ต้องใช้ปิดเกณฑ์ปีนี้ — เคสที่รับเผื่อไว้ปีหน้าไม่ถูกนับ': '\u2460 Counts only the nearest-to-done cases needed for this year\u2019s requirement \u2014 extra cases held for next year are excluded',
  'วิธีคิด': 'How it is calculated',
  'แดง': 'Red',
  'ส้ม': 'Amber',
  'เขียว': 'Green',
  'สีบอกว่า “ปิดเกณฑ์รายปีทันไหม”': "Colors answer: will they finish this year's requirement in time?",
  'ซ่อนคำอธิบายสี': 'Hide color guide',
  'สีพวกนี้คิดยังไง?': 'How are these colors decided?',
  ...
  'ขั้นถัดไป': 'Next step',
  'นำเข้าทั้งรุ่นจากชีตจริง (ทีเดียวทุกกลุ่ม)': 'Import a whole cohort from the real sheet (all groups at once)',
  'เลือกไฟล์ CSV ทีเดียวหลายไฟล์: Student list + PT1–PT12 · ระบบแยกชนิดไฟล์เองจากเนื้อใน': 'Select multiple CSV files at once: Student list + PT1\u2013PT12 \u00b7 file types are detected from content',
  '⚠️ การยืนยันจะล้างข้อมูลเดโมทั้งหมดแล้วแทนด้วยรุ่นจริง — ใช้กับเครื่องทดลอง local เท่านั้น': '\u26a0\ufe0f Confirming wipes ALL demo data and replaces it with the real cohort \u2014 local experiments only',
  'รายชื่อ': 'Roster',
  ...
  'นำเข้าทั้งรุ่นจากชีต: {s} คน · {g} กลุ่ม · {p} ผู้ป่วย · {w} ชิ้นงาน': 'Imported whole cohort from sheet: {s} students \u00b7 {g} groups \u00b7 {p} patients \u00b7 {w} workpieces',
  'นำเข้าเสร็จ: {s} คน · {p} ผู้ป่วย · {w} ชิ้นงาน — ข้อมูลเดโมถูกแทนที่แล้ว': 'Done: {s} students \u00b7 {p} patients \u00b7 {w} workpieces \u2014 demo data replaced',
  ...
  'แดง · ต้องตาม': 'Red · needs follow-up',
  'เหลือเผื่อไม่ถึง 30% · หรืองานกินคาบเกินที่มี · หรือยังไม่มีเคสในมือ · หรือมาคลินิกแล้ว step ไม่ขยับ 3 คาบติด': 'Less than 30% slack · or work exceeds remaining periods · or no case in hand · or no step progress for 3 periods in a row',
  '③ เทียบกับคาบที่เหลือถึงปลายปีการศึกษา — ตอนนี้ ~{n} คาบ (เกิน ~{a} คาบเมื่อไหร่ = แดง)': '③ Compare with periods left until year end — now ~{n} (over ~{a} = red)',
  ...
  'นำเข้าอาจารย์ได้เฉพาะหัวหน้ารายวิชา — เป็นการให้สิทธิ์เข้าระบบ': 'Only course leads can import instructors — it grants system access',
  ...
  '1 จุด = 1 ชิ้นงาน · วงแดง = ค้างเกิน {d} วัน · กดเลข step ใต้กราฟเพื่อดูขั้นตอน': '1 dot = 1 piece · red ring = idle over {d} days · click a step number below to see its procedures',
  '{n} ชิ้น': '{n} pieces',
  'วางจาก Excel หรือ CSV — รหัส, ชื่อ, กลุ่ม': 'Paste from Excel or CSV — ID, name, group',
  '→ ขึ้นปี 5 ปีการศึกษา {y}': '→ Year 5 in academic year {y}',
  'กรอกเลขรุ่นก่อน': 'Enter the cohort number first',
  'ใส่อีเมลที่จะใช้สมัคร แล้วเลือกว่าเป็นใคร': 'Enter the sign-up email, then choose who it is',
  '+ เพิ่ม': '+ Add',
  ...
  'ให้คะแนนผิดกด “แก้” ได้ · ทุกการแก้บันทึกไว้ ลบไม่ได้': 'Scored wrong? Tap “Edit” · every edit is kept and cannot be deleted',
  'กดชื่อเพื่อดูงานรายคน': 'Tap a name to see their work',
  'สีจุด: เขียว = ตามแผน · ส้ม = จับตา · แดง = เสี่ยงสูง': 'Dot colors: green = on track · orange = watch · red = high risk',
  ...
  'ยังส่งไม่ขึ้น — ดูสาเหตุที่หน้า “การเชื่อมต่อ & sync”': 'Still not uploaded — see why under \u201cConnection & sync\u201d',
  ...
  'สมุด': 'Book',
  'Clinical Performance Portfolio — คีย์ผลที่นี่ แล้วพิมพ์ออกไปลงนามบนกระดาษ':
    'Clinical Performance Portfolio — enter results here, print, then sign on paper',
  'Section II · แผนการรักษา': 'Section II · Treatment planning',
  ...
  'ส่งแล้วแก้เองไม่ได้ อาจารย์ที่ปรึกษาจะเห็นคำตอบทั้งหมด และระบบจะสรุปเทียบกับผลงานจริงให้อาจารย์อ่านก่อนนัดคุย': 'Once submitted you cannot edit it. Your advisor sees every answer, and the app prepares a summary against your actual work for them to read before the meeting.',
  ...
  'ส่งแล้วเมื่อ {d}': 'Submitted {d}',
  'ส่งเรียบร้อย แก้ไม่ได้แล้ว — ถ้าต้องแก้ให้บอกอาจารย์ที่ปรึกษา': 'Submitted and locked — ask your advisor if something needs changing',
  'ไม่ได้ตอบ': 'No answer',
  'ไม่บังคับ': 'optional',
  ...
  'ปีละครั้ง ตอนจบเทอม 1 · บันทึกร่างได้': 'Once a year at the end of term 1 · drafts are saved',
  ...
  'สรุปนี้มาจากกฎที่ตั้งไว้ในระบบ ไม่ใช่คำตัดสิน — ใช้เป็นประเด็นตั้งต้นในการคุยกับนักศึกษา': 'This summary comes from fixed rules, not a judgement — use it as a starting point with the student',
  ...
  'การสอบ': 'Examinations',
  'สอบ': 'Exams',
  'OSCE และสอบ RPD design — บันทึกแค่ผ่าน/ไม่ผ่าน ตัวข้อสอบใช้กระดาษตามเดิม': 'OSCE and the RPD design exam — record pass/fail only; the exams themselves stay on paper',
  ...
  'งาน RPD': 'RPD',
  'งาน CD': 'CD',
  'คีย์ผลที่นี่ แล้วพิมพ์ออกไปลงนามบนกระดาษ': 'Enter results here, then print and sign on paper',
  ...
  /* ── PDPA · สิทธิ์ส่งออก / retention (9 ก.ย. 69) ── */
