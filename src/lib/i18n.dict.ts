...
export const DICT: Record<string, string> = {
  ...
  'นับจริง': 'live',
  'สัปดาห์ติดต่อกันที่มาเช็คอิน': 'week check-in streak',
  '8 สัปดาห์ล่าสุด': 'Last 8 weeks',
  'สัปดาห์นี้': 'This week',
  'ดีสุด {n} สัปดาห์': 'Best {n} weeks',
  'เช็คอินสะสม {n} ครั้ง': '{n} check-ins total',
  'streak แบบไม่ใจร้าย: นับเป็นสัปดาห์ ขาดวันเดียวไม่ดับ — หายทั้งสัปดาห์ถึงเริ่มนับใหม่': 'A kind streak: counted by week, missing a day never breaks it — only a fully missed week resets the count',
