...
export const DICT: Record<string, string> = {
  ...
  '③ เทียบกับคาบที่เหลือถึงปลายปีการศึกษา — ตอนนี้ ~{n} คาบ (เส้นส้มที่ ~{a} คาบ)': '\u2462 Compare with periods left until year end \u2014 currently ~{n} (amber line at ~{a})',
  ...
  'คาบที่เหลือไม่พอตามจังหวะเฉลี่ย · หรือยังไม่มีเคสในมือเลย · หรือมาคลินิกแล้ว step ไม่ขยับ 3 คาบติด': 'Not enough periods left at the average pace \u00b7 or no active case at all \u00b7 or attended 3 periods in a row with no step passed',
  'ใช้ 70–100% ของคาบที่เหลือ — ทันแต่ห้ามหยุด': 'Needs 70\u2013100% of the periods left \u2014 feasible but no slack',
  'งานที่เหลือใช้ไม่ถึง 70% ของคาบที่เหลือ — มีที่หายใจ': 'Remaining work needs under 70% of the periods left \u2014 room to breathe',
  'แดง': 'Red',
  'ส้ม': 'Amber',
  'เขียว': 'Green',
