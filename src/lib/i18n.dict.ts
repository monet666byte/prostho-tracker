...
export const DICT: Record<string, string> = {
  ...
  'บันทึกแล้ว — กลุ่ม {g} เป็นกลุ่มที่ปรึกษาของคุณ': 'Saved — group {g} is now your advisory group',
  'ถอนตัวจากกลุ่ม {g} แล้ว': 'You left group {g}',
  'คุณเป็นอาจารย์ที่ปรึกษากลุ่มไหน?': 'Which group do you advise?',
  'กลุ่มที่ปรึกษาของฉัน': 'My advisory groups',
  'มีกลุ่มที่ยังไม่มีอาจารย์ที่ปรึกษา — เลือกครั้งเดียว แอปจะเปิดกลุ่มนั้นเป็นกลุ่มของคุณ และให้คุณยืนยันบัญชีนักศึกษาในกลุ่มได้': 'Some groups have no advisor yet — pick once and the app will open that group as yours and let you confirm its students\' accounts',
  'เลือกหรือถอนตัวได้เอง · กลุ่มหนึ่งมีได้ 2 ท่าน · ถ้าเต็มแล้วแต่ไม่ถูกต้อง ติดต่อหัวหน้าภาค': 'Join or leave groups yourself · up to 2 advisors per group · if a group is full but wrong, contact the head of department',
  'ยังไม่มีกลุ่มของรุ่นที่กำลังเรียน': 'No groups for current cohorts yet',
  'ยังไม่มีที่ปรึกษา': 'No advisor yet',
  'ถอนตัว': 'Leave',
  'กลุ่มนี้มีอาจารย์ที่ปรึกษาครบ 2 ท่านแล้ว': 'This group already has 2 advisors',
  'ครบแล้ว': 'Full',
  'ฉันดูแลกลุ่มนี้': 'I advise this group',
  'ไม่ได้เป็นที่ปรึกษากลุ่มในรุ่นนี้': 'I don\'t advise a group in this cohort',
  'บันทึกที่ปรึกษากลุ่ม {g} แล้ว': 'Saved advisors for group {g}',
  'อาจารย์ที่ปรึกษาแต่ละกลุ่ม': 'Advisors by group',
  'อาจารย์เลือกกลุ่มเองได้ตอนเข้าแอป · ตรงนี้ไว้ตรวจและแก้ให้ถูก · กลุ่มหนึ่งมีได้ 2 ท่าน': 'Instructors can pick their own group in the app · check and correct here · up to 2 per group',
  'ที่ปรึกษา': 'advisor',
  '— ไม่มี —': '— none —',
