 ...
 *
 * ทำไมต้องมี: ใส่ชิ้นงานที่มี `type` ซึ่ง catalog รุ่นนี้ไม่รู้จัก
      ...
      <div style={{ minHeight: '100%', display: 'grid', placeItems: 'center', padding: 24 }}>
        <div style={{ maxWidth: 380, display: 'grid', gap: 12, textAlign: 'center' }}>
          ...
          <div style={{
            ...
            {/* แสดงแค่ชนิดของ error — ข้อความเต็มอาจมีคีย์/ชื่อจากข้อมูลผู้ป่วยปนอยู่ และผู้ใช้ถูกขอให้ถ่ายหน้าจอนี้ส่งต่อ (ข้อความเต็มอยู่ใน console) */}
